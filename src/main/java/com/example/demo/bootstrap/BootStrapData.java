...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        tabletKit.setInv(10);
        tabletKit.setMaxInv(65);
        tabletKit.setMinInv(2);
        ...
        fullDesktopKit.setMaxInv(65);
        fullDesktopKit.setMinInv(2);
        ...
        miniDesktopKit.setMaxInv(65);
        miniDesktopKit.setMinInv(2);
        ...
        noVideoGFX_9090.setInv(6);
        noVideoGFX_9090.setPrice(2450.0);
        noVideoGFX_9090.setId(204);
        noVideoGFX_9090.setMaxInv(10);
        noVideoGFX_9090.setMinInv(2);
        ...
        fmdRadonMLG_7700MS.setMaxInv(35);
        fmdRadonMLG_7700MS.setMinInv(3);
        ...
        fmdRadonMLG_7800MS.setMaxInv(30);
        fmdRadonMLG_7800MS.setMinInv(3);
        ...
        fmdRadonMLG_7900MS.setInv(14);
        fmdRadonMLG_7900MS.setPrice(865.0);
        fmdRadonMLG_7900MS.setId(207);
        fmdRadonMLG_7900MS.setMaxInv(15);
        fmdRadonMLG_7900MS.setMinInv(3);
        ...
        fmdRadonMLG_7900SMS.setInv(10);
        fmdRadonMLG_7900SMS.setPrice(1345.0);
        fmdRadonMLG_7900SMS.setId(208);
        fmdRadonMLG_7900SMS.setMaxInv(10);
        fmdRadonMLG_7900SMS.setMinInv(1);
        ...
        fmdFallenK5_7700MT.setInv(53);
        fmdFallenK5_7700MT.setPrice(290.0);
        fmdFallenK5_7700MT.setId(210);
        fmdFallenK5_7700MT.setMaxInv(80);
        fmdFallenK5_7700MT.setMinInv(5);
        ...
        fmdFallenK5_7950MT.setMaxInv(30);
        fmdFallenK5_7950MT.setMinInv(2);
        ...
        smartS5_25600.setMaxInv(100);
        smartS5_25600.setMinInv(5);
        ...
        smartS5_25600X.setInv(55);
        smartS5_25600X.setPrice(350.0);
        smartS5_25600X.setId(215);
        smartS5_25600X.setMaxInv(70);
        smartS5_25600X.setMinInv(5);
        ...
        smartS7_25700X.setInv(29);
        smartS7_25700X.setPrice(480.0);
        smartS7_25700X.setId(216);
        smartS7_25700X.setMaxInv(30);
        smartS7_25700X.setMinInv(5);
        ...
        smartS9_25900X.setMaxInv(15);
        smartS9_25900X.setMinInv(5);
